...
public class Elf extends MiddleEarthCharacter {
		 ...
		 * 
		 * @return If the  target is ineffective against our attacks return false(elf and dwarf), 
		 * if the target is extremely susceptible to our attacks (Orc), give 1.5x damage, if the target is normal effectiveness against our attacks, return true (human and wizard)
		 */
		 ...
		 boolean attack(MiddleEarthCharacter target)
        {
			...
			/*
			 * @return "Elf"
			 * returns the race of the character in string form (in this case Elf), this is used in the attack method as well, to identify and differentiate each character
			 */
		}
		@Override
		String getRace()
