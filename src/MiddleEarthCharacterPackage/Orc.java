...
public class Orc extends MiddleEarthCharacter {
		 ...
		 * 
		 * @return If the  target is ineffective against our attacks return false(Orc and Elf), 
		 * if the target is extremely susceptible to our attacks (Human), give 1.5x damage, if the target is normal effectiveness against our attacks, return true (Dwarf and Wizard)
		 */
		...
		/*
		 * @return "Orc"
		 * returns the race of the character in string form (in this case Orc), this is used in the attack method as well, to identify and differentiate each character
		 */
