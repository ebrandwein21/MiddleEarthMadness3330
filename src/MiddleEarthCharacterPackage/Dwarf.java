...
public class Dwarf extends MiddleEarthCharacter{
		 ...
		 * 
		 * @return If the  target is ineffective against our attacks return false(wizard and dwarf), 
		 * if the target is extremely susceptible to our attacks (Elf), give 1.5x damage, if the target is normal effectiveness against our attacks, return true (human and orc)
		 */
		...
		/*
		 * @return "Dwarf"
		 * returns the race of the character in string form (in this case Dwarf), this is used in the attack method as well, to identify and differentiate each character
		 */
		@Override
		String getRace()
		{
